...
//            private ArrayList<NotReadList.NotReadBean> list_num;
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                //获取每个聊天未读消息 点击通知栏消息 更新缓存未读数
//                list_num = (ArrayList<NotReadList.NotReadBean>) SharedPreferencesUtil.get(appContext, "listNum", "listNum");
//                if(list_num!= null && list_num.size()>0){
//                    for(NotReadList.NotReadBean notReadBean : list_num) {
//                        if(!StringUtil.isEmpty(notReadBean.getHxUserid())){
//                            if(notReadBean.getHxUserid().equals(message.getFrom())){
//                                notReadBean.setNum(0);
//                                break;
//                            }
//                        }
//                    }
//                }
//                //存储未读消息数
//                SharedPreferencesUtil.save(appContext,"listNum","listNum",list_num);
                return intent;
            }
        });
    }
